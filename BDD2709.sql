...
CREATE TABLE IF NOT EXISTS `categorie` (
  ...
  `data_card` longtext COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`)
...
-- Listage des données de la table tramstras.images_users : ~6 rows (environ)
...
INSERT INTO `post` (`id`, `topic_id`, `text`, `date_post`, `user_id`) VALUES
	...
	(27, 1, 'test123', '2023-09-27 07:01:55', 1);
...
-- Listage des données de la table tramstras.user : ~7 rows (environ)
