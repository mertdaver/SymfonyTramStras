...
-- Listage des données de la table tramstras.alerte : ~17 rows (environ)
INSERT INTO `alerte` (`id`, `ligne`, `alerte_date`, `sens`, `user_id`) VALUES
	...
	(38, 'Ligne C', '2023-09-12 07:18:47', 'Neuhof Rodolphe Reuss', NULL),
	(39, 'Ligne D', '2023-09-12 07:33:12', 'Kehl Rathaus', 1),
	(40, 'Ligne E', '2023-09-12 07:33:58', 'Robertsau L\'Escale', NULL);
...
-- Listage des données de la table tramstras.images_users : ~0 rows (environ)
INSERT INTO `images_users` (`id`, `image_name`, `image_size`, `updated_at`, `created_at`) VALUES
	(1, '650055088f3fd.jpg', 63067, '2023-09-12 12:09:44', '2023-09-12 12:09:44');
...
-- Listage des données de la table tramstras.post : ~7 rows (environ)
...
-- Listage des données de la table tramstras.topic : ~6 rows (environ)
...
-- Listage des données de la table tramstras.user : ~3 rows (environ)
INSERT INTO `user` (`id`, `email`, `pseudo`, `roles`, `password`, `is_verified`, `stripe_id`, `images_users_id`) VALUES
	(1, 'pademengel@gmail.com', 'ipoucht', '["ROLE_ADMIN"]', '$2y$13$bo4jBrC8Eg5ukf1N8jl4KOoPg.LMC9XiUuKJ8hVROuInSQcq1SG76', 1, '', NULL),
	(2, 'jupiter116699@gmail.com', 'jupiter169', '["ROLE_ADMIN"]', '$2y$13$brTRM2F5Bb3SlRanZncmb.XfzEiTXDLGTpE05V35HSp1BvEZgknvS', 1, '', NULL),
	(3, 'adminTramStras@proton.me', 'admin', '["ROLE_USER", "ROLE_ADMIN"]', '$2y$13$bo4jBrC8Eg5ukf1N8jl4KOoPg.LMC9XiUuKJ8hVROuInSQcq1SG76', 0, '', NULL),
