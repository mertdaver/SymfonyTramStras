...
-- Listage des données de la table tramstras.alerte : ~20 rows (environ)
...
CREATE TABLE IF NOT EXISTS `categorie` (
  ...
  `data_card` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Listage des données de la table tramstras.doctrine_migration_versions : ~22 rows (environ)
...
INSERT INTO `images_users` (`id`, `image_name`, `image_size`, `updated_at`, `created_at`) VALUES
	...
	(4, '20456790-650185055413d514943402.png', 30067, '2023-09-13 09:46:45', '2023-09-13 11:36:46'),
...
-- Listage des données de la table tramstras.user : ~4 rows (environ)
INSERT INTO `user` (`id`, `email`, `pseudo`, `roles`, `password`, `is_verified`, `stripe_id`, `images_users_id`) VALUES
	(1, 'pademengel@gmail.com', 'ipoucht', '["ROLE_ADMIN"]', '$2y$13$bo4jBrC8Eg5ukf1N8jl4KOoPg.LMC9XiUuKJ8hVROuInSQcq1SG76', 1, '', 4),
