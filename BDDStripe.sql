...
-- Listage des données de la table tramstras.alerte : ~6 rows (environ)
...
-- Listage des données de la table tramstras.doctrine_migration_versions : ~16 rows (environ)
...
-- Listage des données de la table tramstras.marker : ~33 rows (environ)
...
-- Listage des données de la table tramstras.post : ~4 rows (environ)
INSERT INTO `post` (`id`, `topic_id`, `text`, `date_post`, `user_id`) VALUES
	...
	(14, 1, 'dhnytdnbf', '2023-08-02 09:30:14', 1);
...
-- Listage des données de la table tramstras.topic : ~5 rows (environ)
