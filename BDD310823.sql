...
-- Dumping database structure for tramstras
...
-- Dumping structure for table tramstras.alerte
...
-- Dumping data for table tramstras.alerte: ~8 rows (approximately)
...
-- Dumping structure for table tramstras.categorie
...
-- Dumping data for table tramstras.categorie: ~9 rows (approximately)
...
-- Dumping structure for table tramstras.contact_message
...
-- Dumping data for table tramstras.contact_message: ~0 rows (approximately)

-- Dumping structure for table tramstras.doctrine_migration_versions
...
-- Dumping data for table tramstras.doctrine_migration_versions: ~19 rows (approximately)
...
-- Dumping structure for table tramstras.favoris
...
-- Dumping data for table tramstras.favoris: ~0 rows (approximately)

-- Dumping structure for table tramstras.invoice
...
-- Dumping data for table tramstras.invoice: ~0 rows (approximately)

-- Dumping structure for table tramstras.marker
...
-- Dumping data for table tramstras.marker: ~36 rows (approximately)
...
-- Dumping structure for table tramstras.messenger_messages
...
-- Dumping data for table tramstras.messenger_messages: ~2 rows (approximately)
...
-- Dumping structure for table tramstras.plan
...
-- Dumping data for table tramstras.plan: ~0 rows (approximately)
...
-- Dumping structure for table tramstras.post
...
-- Dumping data for table tramstras.post: ~6 rows (approximately)
...
-- Dumping structure for table tramstras.subscription
...
-- Dumping data for table tramstras.subscription: ~0 rows (approximately)

-- Dumping structure for table tramstras.topic
...
-- Dumping data for table tramstras.topic: ~0 rows (approximately)
...
-- Dumping structure for table tramstras.user
CREATE TABLE IF NOT EXISTS `user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `email` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pseudo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `roles` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- Dumping data for table tramstras.user: ~3 rows (approximately)
INSERT INTO `user` (`id`, `email`, `pseudo`, `roles`, `password`, `is_verified`, `stripe_id`) VALUES
	...
	(3, 'adminTramStras@proton.me', 'admin', '["ROLE_USER", "ROLE_ADMIN"]', '$2y$13$bo4jBrC8Eg5ukf1N8jl4KOoPg.LMC9XiUuKJ8hVROuInSQcq1SG76', 0, '');

-- Dumping structure for table tramstras.user_notification
...
-- Dumping data for table tramstras.user_notification: ~0 rows (approximately)
...
-- Dumping structure for table tramstras.webhook
...
-- Dumping data for table tramstras.webhook: ~7 rows (approximately)
